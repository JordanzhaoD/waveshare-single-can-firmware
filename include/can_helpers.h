...
// (dashSoftEngageRelease removed in v1.18 with the #108 steer-jerk defense
// family — the Soft Engage angle gate never stopped the 2026.8.3.6
// activation jerk and the 8.3.6 cancel/re-request coordinator replaces the
// whole admission chain when armed.)
